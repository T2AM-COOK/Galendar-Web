...
const ContestInfo = () => {
  ...
  return (
    <div style={{backgroundColor:"#F9F9F9", display:"flex", flexDirection:"column", minHeight:"100vh"}}>
    <Topbar/>
    <S.Content>
      <S.ContentBox>
        <S.Text>
    ...
    <S.ContestDetail>
      <S.DetailBox>
          ...
          <S.DetailInfo>해커그라운드 해커톤 2024 in 의성해커그라운드 해커톤 2024 in 의성해커그라운드 해커톤 2024 in 의성 의성해커그라운드 해커톤 2024 in 의성 의성해커그라운드 해커톤 2024 in 의성</S.DetailInfo>
      </S.DetailBox>
    </S.ContestDetail>
    </div>
  )
